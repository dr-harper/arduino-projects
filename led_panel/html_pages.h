...
<title>LED Panel — Login</title>%CSS%</head><body>
...
<h1 style="justify-content:center">🟦 LED Panel</h1>
...
<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>LED Panel Control</title>%CSS%</head><body>
<div class="container">
...
<h2>Effects</h2>
<div class="btn-grid">
  <button class="btn-effect" data-e="0" id="eff0">🕐 Clock</button>
  ...
  <button class="btn-effect" data-e="5" id="eff5">🔥 Fire</button>
  <button class="btn-effect" data-e="6" id="eff6">🌌 Aurora</button>
  <button class="btn-effect" data-e="7" id="eff7">🫧 Lava Lamp</button>
  <button class="btn-effect" data-e="8" id="eff8">🕯 Candle</button>
  <button class="btn-effect" data-e="9" id="eff9">✨ Twinkle</button>
  <button class="btn-effect" data-e="10" id="eff10">💚 Matrix</button>
  <button class="btn-effect" data-e="11" id="eff11">🎆 Fireworks</button>
  <button class="btn-effect" data-e="12" id="eff12">🧬 Life</button>
  <button class="btn-effect" data-e="13" id="eff13">🌀 Plasma</button>
  <button class="btn-effect" data-e="14" id="eff14">🌀 Spiral</button>
</div>
</div>
...
<h2>🎮 Games</h2>
<div class="btn-grid">
  <button class="btn-effect btn-game" data-e="15" id="eff15">🧱 Tetris</button>
  <button class="btn-effect btn-game" data-e="16" id="eff16">🐍 Snake</button>
</div>
...
<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>LED Panel — Settings</title>%CSS%</head><body>
<div class="container">
<h1><a href="/" style="text-decoration:none">←</a> Settings</h1>

<div class="tabs">
  <div class="tab active" onclick="showTab(0)">AI Tuning</div>
  <div class="tab" onclick="showTab(1)">Network</div>
...
<div class="info-row"><span class="info-label">mDNS</span><span class="info-value">ledpanel.local</span></div>
</div>
<div class="card">
...
<title>LED Panel — Tetris</title>%CSS%
<style>
#grid{display:block;margin:0 auto;border-radius:8px;image-rendering:pixelated;
  border:2px solid #2a2a4a;touch-action:none;width:100%;max-width:480px;aspect-ratio:4/1}
...
<canvas id="grid" width="640" height="160"></canvas>
...
function drawGrid(grid){
  ...
  var px=canvas.width/COLS;
  ctx.fillStyle='#0f0f1a';
  ctx.fillRect(0,0,canvas.width,canvas.height);
  for(var i=0;i<COLS*ROWS;i++){
    var x=(i%COLS)*px, y=Math.floor(i/COLS)*px;
    var c=grid[i];
    if(c===0){continue;}
...
<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>LED Panel — Firmware Update</title>%CSS%</head><body>
<div class="container">
